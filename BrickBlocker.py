...
pygame.display.set_caption("BRICK BLOCKER")
...
def set_vars():
    global NUM_SPAWN, SPAWN_TIMER, MAX_SPAWN, GAME_OVER, start, GRAY_ALIVE, ORANGE_ALIVE, PINK_ALIVE, BRICK_VEL
    NUM_SPAWN = -1
    SPAWN_TIMER = 1100 #ms between spawns
    MAX_SPAWN = 450
    GAME_OVER = False
...
def draw_startMenu():
    ...
    title2 = FONT.render("BRICK BLOCKER",75,PINK) 
...
def main():
    global NUM_SPAWN
    global SPAWN_TIMER, MAX_SPAWN, BRICK_VEL
    global GAME_OVER, SCORE, QUIT
